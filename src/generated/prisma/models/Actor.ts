...
export type ActorWhereInput = {
  ...
  tmdbId?: Prisma.IntFilter<"Actor"> | number
  numberOfVotes?: Prisma.IntFilter<"Actor"> | number
  lastVotedAt?: Prisma.DateTimeNullableFilter<"Actor"> | Date | string | null
}

export type ActorOrderByWithRelationInput = {
  tmdbId?: Prisma.SortOrder
  numberOfVotes?: Prisma.SortOrder
  lastVotedAt?: Prisma.SortOrderInput | Prisma.SortOrder
}
...
export type ActorScalarWhereWithAggregatesInput = {
  ...
  tmdbId?: Prisma.IntWithAggregatesFilter<"Actor"> | number
  numberOfVotes?: Prisma.IntWithAggregatesFilter<"Actor"> | number
  lastVotedAt?: Prisma.DateTimeNullableWithAggregatesFilter<"Actor"> | Date | string | null
}

export type ActorCreateInput = {
  tmdbId: number
  numberOfVotes: number
  lastVotedAt?: Date | string | null
}
...
export type ActorUpdateInput = {
  ...
  lastVotedAt?: Prisma.NullableDateTimeFieldUpdateOperationsInput | Date | string | null
}
...
export type ActorOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"tmdbId" | "numberOfVotes" | "lastVotedAt", ExtArgs["result"]["actor"]>
...
export interface ActorDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const actorWithTmdbIdOnly = await prisma.actor.findMany({ select: { tmdbId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Actors and only return the `tmdbId`
   * const actorWithTmdbIdOnly = await prisma.actor.createManyAndReturn({
   *   select: { tmdbId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Actors and only return the `tmdbId`
   * const actorWithTmdbIdOnly = await prisma.actor.updateManyAndReturn({
   *   select: { tmdbId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ActorFieldRefs {
  readonly tmdbId: Prisma.FieldRef<"Actor", 'Int'>
  readonly numberOfVotes: Prisma.FieldRef<"Actor", 'Int'>
  readonly lastVotedAt: Prisma.FieldRef<"Actor", 'DateTime'>
}
